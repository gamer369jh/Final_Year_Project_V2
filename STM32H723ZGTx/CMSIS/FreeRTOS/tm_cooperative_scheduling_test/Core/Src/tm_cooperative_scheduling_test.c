...
extern osThreadId_t    tm_thread_array[];
...
void  tm_cooperative_scheduling_initialize(void)
{
    ...
    tm_thread_create(0, 10, tm_cooperative_thread_0_entry);
    tm_thread_create(1, 10, tm_cooperative_thread_1_entry);
    tm_thread_create(2, 10, tm_cooperative_thread_2_entry);
    tm_thread_create(3, 10, tm_cooperative_thread_3_entry);
    tm_thread_create(4, 10, tm_cooperative_thread_4_entry);
    ...
    tm_thread_create(5, osPriorityRealtime, tm_cooperative_thread_report);
    tm_thread_resume(5);
}
